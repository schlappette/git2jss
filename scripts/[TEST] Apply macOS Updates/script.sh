...
ReminderNotification="PCC IT: There is a${addMajorText}software $addMajorUpgradeText available for your Mac that should be installed at your earliest convenience. If you have any questions, please contact $ITContact.
...
NaggingNotification="PCC IT: There is a${addMajorText}software $addMajorUpgradeText available for your Mac that should be installed at your earliest convenience. Click Proceed to ensure your computer is in compliance with the latest security updates. If you have any questions, please contact $ITContact.
You may install this macOS software $addMajorUpgradeText at any time by navigating to:
$StepsToUpgrade"

# Default final notification
FinalNotification="PCC IT: There is a${addMajorText}software $addMajorUpgradeText available for your Mac that should be installed as soon as possible. It is required that you $addMajorUpgradeText this computer as soon as possible, but you can you postpone if necessary.
...
FinalCallNotificationForCLIUpdate="PCC IT: There is a${addMajorText}software $addMajorUpgradeText available for your Mac that needs to be installed immediately. There are no opportunities left to postpone this $addMajorUpgradeText any further.
...
FinalCallNotificationForGUIUpdate="PCC IT: There is a${addMajorText}software $addMajorUpgradeText available for your Mac that needs to be installed immediately. There are no opportunities left to postpone this $addMajorUpgradeText any further.
