...
InstallerPKG="McAfee-Threat-Prevention-for-Mac-10.6.7-RTW-standalone-108.pkg"
...
/Library/IT/McAfee_Files/McAfee_Agent_installer.sh -i

# Install the Mcafee Security Product
installer -pkg /Library/IT/McAfee_Files/$InstallerPKG -allowUntrusted -target /
