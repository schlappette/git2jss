...
sudo -u "$CURRENTUSER" /private/tmp/DEPNotify_Mojave/DEPNotify.app/Contents/MacOS/DEPNotify -path /private/tmp/DEPNotify_Mojave/depnotify.log &

# Open DEPNofity in Full Screen Mode
